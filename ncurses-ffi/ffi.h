#ifndef __NCURSES_ML_H__
#define __NCURSES_ML_H__
...
#if !defined(PART_OF_NCURSES) && \
    !defined(STATIC_LINK_NCURSES) && \
    !defined(DYNAMIC_LINK_NCURSES)
#define PART_OF_NCURSES
#endif

#if defined(PART_OF_NCURSES)
#define MLLIB_PRIVATE(x) PRIVATE x
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(STATIC_LINK_NCURSES)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(DYNAMIC_LINK_NCURSES)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) EXTERNAL x
#else
#error Must specify linkage for ncurses
#define MLLIB_PRIVATE(x)
